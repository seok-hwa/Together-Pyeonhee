export const Calculator1 = (mbti1_2, mbti1_3, mbti1_4, mbti1_5) => {
    let totalScore = 0;
...
export const Calculator2 = (mbti2_1, mbti2_2, mbti2_3, mbti2_4) => {
    let totalScore = 0;
...
export const Calculator3 = (mbti3_2, mbti3_3, mbti3_4, mbti3_5) => {
    let totalScore = 0;
...
export const Calculator4 = (mbti4_1, mbti4_2, mbti4_3, mbti4_4) => {
    let totalScore = 0;
