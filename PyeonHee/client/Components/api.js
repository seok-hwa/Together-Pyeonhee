...
export const MonthReportCabinetApi = (userID) => {
    return new Promise(function(resolve, reject) {
        console.log(`${url}/monthReport/Cabinet/info`);
        fetch(`${url}/monthReport/Cabinet/info`, {
            method: 'POST',
            body: JSON.stringify({
                userID: userID,
            }),
...
export const loadUserInfoApi = (userID) => {
    return new Promise(function(resolve, reject) {
        console.log(`${url}/myPage/load?userID=${userID}`);
        fetch(`${url}/myPage/load?userID=${userID}`)   //get
        .then((response)=>response.json())
        .then((responseJson)=>{
            resolve(responseJson);
        })
...
export const passwordCheckApi = (userID, userPassword) => {
    return new Promise(function(resolve, reject) {
        console.log(`${url}/myPage/checkPassword`);
        fetch(`${url}/myPage/checkPassword`, {
            method: 'POST',
            body: JSON.stringify({
              userID: userID,
              userPassword: userPassword,
...
export const updateUserInfoApi = (userID, userAge, userJob) => {
    return new Promise(function(resolve, reject) {
        console.log(`${url}/myPage/update`);
        fetch(`${url}/myPage/update`, {
            method: 'POST',
            body: JSON.stringify({
              userID: userID,
              userAge: userAge,
