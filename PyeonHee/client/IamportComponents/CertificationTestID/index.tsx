...
type Props = StackScreenProps<RootStackParamList, 'CertificationTestID'>;

function CertificationTestID({ navigation }: Props) {
        ...
        <FormControl p={'5%'} borderRadius={3}>
          ...
          <Button
            ...
            onPress={() => {
              ...
              navigation.navigate('CertificationID', data);
            }}
          >
...
export default CertificationTestID;