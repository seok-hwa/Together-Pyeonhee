...
function FinancialPensionList(props) {
  ...
  useEffect(() => {
    axios({
      method:"GET",
      url: '/admin/financialPensionListTotalPage',
    })
    .then((res)=>{
    ...
    .then(()=>{
      axios({
        method:"POST",
        url: `/admin/getFinancialPensionList`,
        data:{
      ...
      <div className="NotificationBodyDiv">
        <Paper className={classes.root}>
          <Table className={classes.table}>
            ...
            <TableBody>
              {financialItems.map(c => {return (<PensionItems key={c.pension_number} id={c.pension_number} category={c.bank_name} name={c.product_name} company_name={c.bank_name}/>)})}
            </TableBody>
          </Table>
        </Paper>
