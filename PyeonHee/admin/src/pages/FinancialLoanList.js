...
function FinancialLoanList(props) {
  const {classes} = props;
  ...
  function paginateNext(number){
    document.location.href = `/financialLoanList/${number}`;
  }
  ...
  return (
    <div className="NotificationDiv">
      ...
      >
        ...
        <option value="대출" selected>대출</option>
      ...
      <div className="NotificationBodyDiv">
        <Paper className={classes.root}>
          <Table className={classes.table}>
            ...
            <TableBody>
              {financialItems.map(c => {return (<LoanItems key={c.product_number} id={c.product_number} category={c.product_category} name={c.product_name} company_name={c.company_name}/>)})}
            </TableBody>
          </Table>
        </Paper>
...
export default withStyles(styles)(FinancialLoanList);